...
@MetaInfServices(value=EncodeCodeProvider.class)
public class JodaTimeEncoder implements EncodeCodeProvider {
	...
	public void putEncodeCode(CodeBlock.Builder cb, TypeMirror tm, Collection<EncodeCodeProvider> allProviders, String varName) {
		cb.addStatement("writer.writeDateTime($L.getMillis())", varName);
	}
}